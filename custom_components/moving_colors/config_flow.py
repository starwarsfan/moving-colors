...
YAML_CONFIG_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(MCInternal.ENABLED_MANUAL.value): cv.boolean,
        vol.Optional(MCConfig.START_VALUE_ENTITY.value): cv.entity_id,
        vol.Optional(MCInternal.START_VALUE_MANUAL.value): vol.Coerce(float),
        vol.Optional(MCConfig.MIN_VALUE_ENTITY.value): cv.entity_id,
        vol.Optional(MCInternal.MIN_VALUE_MANUAL.value): vol.Coerce(float),
        vol.Optional(MCConfig.MAX_VALUE_ENTITY.value): cv.entity_id,
        vol.Optional(MCInternal.MAX_VALUE_MANUAL.value): vol.Coerce(float),
        vol.Optional(MCConfig.STEPPING_ENTITY.value): cv.entity_id,
        vol.Optional(MCInternal.STEPPING_MANUAL.value): vol.Coerce(float),
        vol.Optional(MCConfig.TRIGGER_INTERVAL_ENTITY.value): cv.entity_id,
        vol.Optional(MCInternal.TRIGGER_INTERVAL_MANUAL.value): vol.Coerce(float),
        vol.Optional(MCConfig.RANDOM_LIMITS_ENTITY.value): cv.entity_id,
        vol.Optional(MCInternal.RANDOM_LIMITS_MANUAL.value): cv.boolean,
        vol.Optional(MCConfig.DEFAULT_VALUE_ENTITY.value): cv.entity_id,
        vol.Optional(MCInternal.DEFAULT_VALUE_MANUAL.value): vol.Coerce(float),
        vol.Optional(MCConfig.DEFAULT_MODE_ENABLED_ENTITY.value): cv.entity_id,
        vol.Optional(MCInternal.DEFAULT_MODE_ENABLED_MANUAL.value): cv.boolean,
